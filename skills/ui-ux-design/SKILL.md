...
---
name: ui-ux-design
description: "Use when working on user interface design, user experience design, product design, interaction design, or digital product design. Domain skill that overlays the DA linear workflow."
---
...
## Overview
A domain-specific methodology layer for UI/UX design. Digital product design has its own logic — it starts with user needs, flows through information architecture and interaction design, and ends with visual interface design. This skill layers on top of the DA linear flow (01-intake → 02-discover → 03-strategy → 04-generate → 05-review → 06-deliver → 07-learn) and adds UX-specific frameworks at each stage.
