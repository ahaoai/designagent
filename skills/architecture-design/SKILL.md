...
description: "Use when working on architectural design, building design, spatial planning, structural concepts, or environmental design. Domain skill that overlays the DesignAgent linear workflow."
---
